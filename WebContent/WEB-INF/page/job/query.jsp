...
<!-- 				</div> -->
		        ...
		        <div>
				<label>岗位名称：</label>
				<input type="text" name="gwName" value="${obj.o.gwName}" size="25" />
				<span class="inputInfo">岗位名称</span>
				</div>
						        <div>
				<label>备注信息：</label>
				<input type="text" name="remark" value="${obj.o.remark}" size="25" />
				<span class="inputInfo">备注信息</span>
				</div>
		        <div>
				<label>岗位状态：</label>
				<input type="text" name="status" value="${obj.o.status}" size="25" />
				<span class="inputInfo">岗位状态</span>
				</div>
<%-- 			    <div>
					<label>创建人：</label>
