			...
			<c:forEach items="${obj.list}" var="acc">
				<tr target="sid_eaxm" rel="${acc.exID }">
					...
					<td><a title="删选择题信息" target="ajaxTodo"
						href="ExamMain/delete?exID=${acc.exID}" class="btnDel">删除选择题信息</a>
						<a title="查看选择题信息" target="navTab"
						href="ExamMain/view?exID=${acc.exID}" class="btnView">查看选择题信息</a>
						<a title="编辑选择题信息" target="dialog"
						href="ExamMain/editUi?exID=${acc.exID}" class="btnEdit">编辑选择题信息</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
